  ...
  return (
    <main className="page">
      ...
      <section className="workspace grid features">
        ...
        <article className="card feature"><span>03</span><h3>Внедрение в команду</h3><p>Настроим понятный процесс: кто загружает, кто проверяет, кто получает отчёт.</p><a href="mailto:support@smetacheck.kg">Обсудить внедрение</a></article>
      </section>
      <Footer/>
    </main>
  )
